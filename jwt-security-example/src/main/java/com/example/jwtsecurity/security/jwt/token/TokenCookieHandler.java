...
public class TokenCookieHandler {
    ...
    public Token getAccessTokenFromCookies(final Cookie[] cookies, String accessTokenName) {
        return CookieParser.getValue(cookies, accessTokenName)
            .map(AccessToken::of)
            .orElse(null);
    }

    public Token getRefreshTokenFromCookies(final Cookie[] cookies, String refreshTokenName) {
