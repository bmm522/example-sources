...
public class FixtureTokenMetadata {
	...
	public static TokenMetadata createTokenMetadata () {
		return TokenMetadata.of(USER_KEY, SECRET, SUBJECT, EXPIRATION_AT, PREFIX, CLAIM);
	}

	public static TokenMetadata createTokenMetadataWithOutClaim () {
		return TokenMetadata.of(USER_KEY, SECRET, SUBJECT, EXPIRATION_AT, PREFIX, null);
	}

	public static TokenMetadata createTokenMetadataWithExpirationAt (final Long expirationAt) {
		return TokenMetadata.of(USER_KEY, SECRET, SUBJECT, expirationAt, PREFIX, CLAIM);
	}
	...
	public static TokenMetadata createAccessTokenMetadata () {
		return TokenMetadata.of(USER_KEY, SECRET, SUBJECT, EXPIRATION_AT, "Bearer ", CLAIM);
	}

	public static TokenMetadata createRefreshTokenMetadata () {
		return TokenMetadata.of(USER_KEY, SECRET, SUBJECT, EXPIRATION_AT, "RefreshToken ", null);
	}
