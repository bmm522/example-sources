...
public class CookieParserTest {
    ...
    void returnCookieMatchedName() {
        ...
        Cookie[] given = FixtureCookie.createCookies(accessTokenValue);

        Optional<String> result = CookieParser.getValue(given, FixtureCookie.ACCESS_TOKEN_COOKIE_NAME);

        assertThat(result.get().equals(accessTokenValue)).isTrue();
    }
    ...
    void returnNullStringWhenNotMatchedName() {
        ...
        Cookie[] given = FixtureCookie.createCookies();

        Optional<String> result = CookieParser.getValue(given, "asdfsadfsadf");
    ...
    void returnNullWhenInputNullCookieArray() {
        Optional<String> result = CookieParser.getValue(null, FixtureCookie.ACCESS_TOKEN_COOKIE_NAME);
