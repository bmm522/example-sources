...
public class TokenCookieHandlerTest {
    ...
    class createCookieTests {
        ...
        void returnAccessTokenCookieWhenInputAccessTokenType() {
            ...
            Cookie result = tokenCookieHandler.createCookie(accessToken);
        ...
        void returnRefreshTokenCookieWhenInputRefreshTokenType() {
            ...
            Cookie result = tokenCookieHandler.createCookie(refreshToken);
    ...
    class getTokenFromCookieTests {
        ...
        void returnAccessTokenWhenInputCookieArrayAndAccessTokenName() {
            ...
            Token result = tokenCookieHandler.getAccessTokenFromCookies(given, FixtureCookie.ACCESS_TOKEN_COOKIE_NAME);
        ...
        void returnRefreshTokenWhenInputCookieArrayAndRefreshTokenName() {
            ...
            Token result = tokenCookieHandler.getRefreshTokenFromCookies(given, FixtureCookie.REFRESH_TOKEN_COOKIE_NAME);
